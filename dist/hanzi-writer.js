/**
 * Hanzi Writer 微信小程序适配版 v3.0.2 | 基于 chanind/hanzi-writer
 */

var HanziWriter = (function () {
  'use strict';

  var _globalObj$requestAni, _globalObj$cancelAnim, _globalObj$navigator;
  ...
  const performanceNow = hasPerformance ? () => globalObj.performance.now() : () => Date.now();
  const requestAnimationFrame = hasPerformance ? ((_globalObj$requestAni = globalObj.requestAnimationFrame) === null || _globalObj$requestAni === void 0 ? void 0 : _globalObj$requestAni.bind(globalObj)) || (callback => setTimeout(() => callback(performanceNow()), 1000 / 60)) : callback => setTimeout(() => callback(performanceNow()), 1000 / 60);
  const cancelAnimationFrame = hasPerformance ? ((_globalObj$cancelAnim = globalObj.cancelAnimationFrame) === null || _globalObj$cancelAnim === void 0 ? void 0 : _globalObj$cancelAnim.bind(globalObj)) || clearTimeout : clearTimeout;
  ...
  class CharacterRenderer$1 {
    constructor(character) {
      ...
      this._strokeRenderers = character.strokes.map(stroke => new StrokeRenderer$1(stroke, false));
    }
    render(ctx, props) {
  ...
  class RenderTarget$1 extends RenderTargetBase {
    ...
    addPointerStartListener(callback) {
      this._startCb = callback;
    }
    addPointerMoveListener(callback) {
      this._moveCb = callback;
    }
    addPointerEndListener(callback) {
    ...
    emitTouchStart(x, y) {
      var _this$_startCb;
      (_this$_startCb = this._startCb) === null || _this$_startCb === void 0 ? void 0 : _this$_startCb.call(this, {
        getPoint: () => ({
          x,
          y
        }),
    ...
    emitTouchMove(x, y) {
      var _this$_moveCb;
      (_this$_moveCb = this._moveCb) === null || _this$_moveCb === void 0 ? void 0 : _this$_moveCb.call(this, {
        getPoint: () => ({
          x,
          y
        }),
    ...
    emitTouchEnd() {
      var _this$_endCb;
      (_this$_endCb = this._endCb) === null || _this$_endCb === void 0 ? void 0 : _this$_endCb.call(this);
    }
    ...
    _mpEvent(evt, x, y) {
      return {
        ...
        preventDefault: () => {
          var _evt$preventDefault;
          return (_evt$preventDefault = evt.preventDefault) === null || _evt$preventDefault === void 0 ? void 0 : _evt$preventDefault.call(evt);
        }
      };
    }
  }
